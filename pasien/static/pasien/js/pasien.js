BASE_URL_PASIEN = window.location.origin + "/pasien";
...
function LoadProfile() {
    ...
    latestPoint = 0
    if (tokenobject["jenis_anggota"] != 1) {
        window.location.replace = BASE_URL_PASIEN + "/logout/"
    }
...
function GetProvinsi() {
    $.ajax({
        type: "GET",
        url: BASE_URL_GLOBAL + "/global/provinsi",
        dataType: "JSON",
